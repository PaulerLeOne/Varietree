...
public class LollipopBirchFoliagePlacer extends ModFoliagePlacer {

	public LollipopBirchFoliagePlacer(IntProvider int_one, IntProvider int_two) {
		super(int_one, int_two);
	}
	
	public static final Codec<LollipopBirchFoliagePlacer> CODEC = RecordCodecBuilder.create( (placer) -> foliagePlacerParts(placer).apply(placer, LollipopBirchFoliagePlacer::new));

	@Override
	protected FoliagePlacerType<?> type() {	
		return FoliagePlacerTypeRegistry.LOLLIPOP_BIRCH_PLACER.get();
	}
